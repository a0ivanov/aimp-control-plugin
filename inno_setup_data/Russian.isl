...
BrowserScriptsDirSelectionMsg1=Выберите каталог скриптов браузера
BrowserScriptsDirSelectionMsg2=Где будут храниться скрипты браузера?
...
PluginOptionsSubDescription=Использование этих возможностей представляет потенциальную опасность для сохраности Ваших данных. Рекомендуется включить защиту соединения паролем.
