...
AboutSetupNote=
TranslatorNote=Wersja polska: Krzysztof Cynarski%n<krzysztof at cynarski.net>%nKorekta: £ukasz Abramczuk%n<lukasz.abramczuk at gmail.com>%nDostosowanie do wtyczki AIMP Control Plugin: Denis Widera%n<deniswidera at gmail.com>
...
BrowserScriptsDirSelectionMsg1=Wybierz lokalizacjê skrytów WWW
BrowserScriptsDirSelectionMsg2=Gdzie chcesz zainstalowaæ pliki ze skryptami WWW?
BrowserScriptsDirSelectionMsg3=Wybierz folder w którym Instalator powinien zainstalowaæ skrypty WWW
...
AimpVerionSelectionMsg2=Wybierz wersjê AIMPa
AimpVerionSelectionMsg3=Zainstaluj wtyczkê dla

PluginOptionsTitle=Funkcje dodatkowe
PluginOptionsDescription=Funkcje dodatkowe, które domyœlnie s¹ wy³¹czone.
PluginOptionsSubDescription=Wybrane funkcje mog¹ byæ niebezpieczne. Wskazane jest w³¹czenie ochrony has³em.

OptionNetworkCheckBox=Zezwól na po³¹czenia z wtyczk¹ z sieci domowej, jak i z sieci globalnej. Us³uga zostanie w³¹czona na wszystkich interfejsach sieciowych.
OptionUploadTracksCheckBox=Zezwól na wysy³anie utworów.
OptionPhysicalTrackDeletionCheckBox=Zezwalaj na fizyczne usuwanie plików z dysku.
OptionSchedulerCheckBox=W³¹cz harmonogram.

SettingsManagerInstallationTitle=Wymagania Mened¿era Ustawieñ
SettingsManagerInstallationDescription=Wymagana rêczna instalacja Frameworka.
SettingsManagerInstallationSubDescription=By móc u¿ywaæ Mened¿era Ustawieñ, proszê œci¹gn¹æ i zainstalowaæ .Net Framework 4.0 
SettingsManagerInstallationMessage=Œci¹gnij instalator .Net 4.0 Framework tutaj: http://www.microsoft.com/en-us/download/details.aspx?id=17851
SettingsManager=Mened¿er Ustawien
SettingsManagerInfo=By chroniæ dostêp z sieci globalnej wskazane jest ustawienie has³a. U¿yj wygodnego Mened¿era Ustawieñ. By go uruchomiæ, wejdŸ do Ustawieñ Wtyczek AIMPa, i kliknij ko³o zêbate wtyczki Control Plugin.

AimpApplicationTerminateQuery=Wskazane jest wy³¹czenie AIMPa by pomyœlnie zainstalowaæ wtyczkê. Zamkn¹æ AIMPa?

DonatePageTitle=Wsparcie
DonatePageTitle2=Wesprzyj projekt
DonateMsg=Wyœlij drobny datek by wesprzeæ projekt.
DonateButton=Wesprzyj

InfoAfterPageMemoTextLocal=Domyœlnie strona startuje w sieci LAN.%nLink testowy: http://localhost:3333/index.htm%nInterfejsy serwera HTTP i port mo¿na zmieniæ w pliku ustawieñ lub w Mened¿erze Ustawieñ.
InfoAfterPageMemoTextRemoteBegin=Strona bêdzie dostêpna pod nastêpuj¹cymi adresami URL
InfoAfterPageMemoTextRemoteEnd=Mo¿e to zostaæ zmienione w pliku ustawieñ.
