...
; Proofreading and corrections for AIMP Control Plugin: Denis "AviciiPL" Widera <deniswidera at gmail.com>
...
;
; $jrsoftware: issrc/Files/Languages/Polish.isl,v 1.2 2016/08/17 14:20:52 jr Exp $
...
AboutSetupNote=
TranslatorNote=Wersja polska: Krzysztof Cynarski%n<krzysztof at cynarski.net>%nKorekta: Łukasz Abramczuk%n<lukasz.abramczuk at gmail.com>%nDostosowanie do wtyczki AIMP Control Plugin: Denis Widera%n<deniswidera at gmail.com>
...
BrowserScriptsDirSelectionMsg1=Wybierz lokalizację skrytów WWW
BrowserScriptsDirSelectionMsg2=Gdzie chcesz zainstalować pliki ze skryptami WWW?
BrowserScriptsDirSelectionMsg3=Wybierz folder w którym Instalator powinien zainstalować skrypty WWW
BrowserScriptsDirDestination=Miejsce instalacji skryptów WWW:
SettingsFileDestination=Lokalizacja pliku z ustawieniami wtyczki:

AimpVerionSelectionMsg1=Wersja odtwarzacza
AimpVerionSelectionMsg2=Wybierz wersję AIMPa
AimpVerionSelectionMsg3=Zainstaluj wtyczkę dla

PluginOptionsTitle=Funkcje dodatkowe
PluginOptionsDescription=Funkcje dodatkowe, które domyślnie są wyłączone.
PluginOptionsSubDescription=Wybrane funkcje mogą być niebezpieczne. Wskazane jest włączenie ochrony hasłem.

OptionNetworkCheckBox=Zezwól na połączenia z wtyczką z sieci domowej, jak i z sieci globalnej. Usługa zostanie włączona na wszystkich interfejsach sieciowych.
OptionUploadTracksCheckBox=Zezwól na wysyłanie utworów.
OptionPhysicalTrackDeletionCheckBox=Zezwalaj na fizyczne usuwanie plików z dysku.
OptionSchedulerCheckBox=Włącz harmonogram.

SettingsManagerInstallationTitle=Wymagania Menedżera Ustawień
SettingsManagerInstallationDescription=Wymagana ręczna instalacja Frameworka.
SettingsManagerInstallationSubDescription=By móc używać Menedżera Ustawień, proszę ściągnąć i zainstalować .Net Framework 4.0 
SettingsManagerInstallationMessage=Ściągnij instalator .Net 4.0 Framework tutaj: http://www.microsoft.com/en-us/download/details.aspx?id=17851
SettingsManager=Menedżer Ustawien
SettingsManagerInfo=By chronić dostęp z sieci globalnej wskazane jest ustawienie hasła. Użyj wygodnego Menedżera Ustawień. By go uruchomić, wejdź do Ustawień Wtyczek AIMPa, i kliknij koło zębate wtyczki Control Plugin.

AimpApplicationTerminateQuery=Wskazane jest wyłączenie AIMPa by pomyślnie zainstalować wtyczkę. Zamknąć AIMPa?

DonatePageTitle=Wsparcie
DonatePageTitle2=Wesprzyj projekt
DonateMsg=Wyślij drobny datek by wesprzeć projekt.
DonateButton=Wesprzyj

InfoAfterPageMemoTextLocal=Domyślnie strona startuje w sieci LAN.%nLink testowy: http://localhost:3333/index.htm%nInterfejsy serwera HTTP i port można zmienić w pliku ustawień lub w Menedżerze Ustawień.
InfoAfterPageMemoTextRemoteBegin=Strona będzie dostępna pod następującymi adresami URL
InfoAfterPageMemoTextRemoteEnd=Może to zostać zmienione w pliku ustawień.
